...
pca_data = sio.loadmat("/home/asdf/Documents/juyan/paper/data/paviau/cnn/pca3_paviau.mat")
...
mat_gt = sio.loadmat("/home/asdf/Documents/juyan/paper/data/paviau/cnn/PaviaU_gt.mat")
GT = mat_gt['paviaU_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
labeled_sets = np.load('/home/asdf/Documents/juyan/paper/data/paviau/cnn/labeled_index.npy')
# test_sets = np.load('/home/asdf/Documents/juyan/paper/data/salinas/original/test_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/data/paviau/cnn/valid_index.npy')
# unlabeled_sets = np.load('/home/asdf/Documents/juyan/paper/data/salinas/original/unlabeled_index.npy')

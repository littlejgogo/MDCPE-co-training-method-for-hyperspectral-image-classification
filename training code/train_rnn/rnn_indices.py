...
mat_gt = sio.loadmat("/home/asdf/Documents/juyan/paper/data/paviau/rnn/PaviaU_gt.mat")
GT = mat_gt['paviaU_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
data_mat = sio.loadmat('/home/asdf/Documents/juyan/paper/data/paviau/rnn/pca_paviau.mat')
...
labeled_sets = np.load('/home/asdf/Documents/juyan/paper/data/paviau/rnn/labeled_index.npy')
# test_sets = np.load('/home/asdf/Documents/juyan/paper/data/original/test_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/data/paviau/rnn/valid_index.npy')

...
import final_index
import numpy as np
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviau/dcpe/model/3_cnn/'
                                   'CNN05093.ckpt.meta')
batch_size = 5000
...
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviau/dcpe/model/3_cnn/'
                                   'CNN05093.ckpt')
...
rnnlogtis = np.load("/home/asdf/Documents/juyan/paper/paviau/dcpe/test/all_rnnlogits.npy")
...
# np.savez('/home/asdf/Documents/juyan/paper/paviau/dcpe/test/test9_zhibiao0522.npz',
#          every_class=every_class, confusion_mat=confusion_mat)
# print("ok")
np.save("/home/asdf/Documents/juyan/paper/paviau/dcpe/test/pre_alllabel.npy", predict_label)
...
# import final_index
# import numpy as np
# saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviau/dcpe/model/10_cnn/'
#                                    'CNN050910.ckpt.meta')
...
# # cnnlogits = np.zeros((1, 9), dtype=np.float64)
# with tf.Session() as sess:
#     saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviau/dcpe/model/10_cnn/'
#                                    'CNN050910.ckpt')
#     y = sess.graph.get_tensor_by_name('Softmax:0')
#     X = sess.graph.get_operation_by_name('X').outputs[0]
#     keep_prob = sess.graph.get_operation_by_name('keep_prob').outputs[0]
...
# rnnlogtis = np.load("/home/asdf/Documents/juyan/paper/paviau/dcpe/model/10_rnn/logits.npy")
#
# norm_rnn = np.zeros((cnnlogits.shape[0], cnnlogits.shape[1]), dtype=np.float32)
# norm_cnn = np.zeros((cnnlogits.shape[0], cnnlogits.shape[1]), dtype=np.float32)
# max_cnn = np.amax(cnnlogits, axis=1)
...
#
# every_class, confusion_mat = final_index.test_data_index(true_label, predict_label, 9)
# np.savez('/home/asdf/Documents/juyan/paper/paviau/dcpe/model/10_rnn/zhibiao0516.npz',
#          every_class=every_class, confusion_mat=confusion_mat)
# print("ok")

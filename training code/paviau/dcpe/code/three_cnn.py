...
with g_cnn.as_default():
    ...
    # tf Graph input
    X = tf.placeholder(tf.float32, [None, 4, 23, 23], name='X')
        ...
        for step in range(1, num_steps+1):
            ...
            if step % 1000 == 0:
                ...
                if val_acc > best:
                    best = val_acc
                    print("Step " + str(step))
                    filename = ('CNN0509.ckpt')
                    filename = os.path.join('/home/asdf/Documents/juyan/paper/paviau/dcpe/model/cnn/',
                                            filename)
                    saver.save(sess, filename)
                    filename = ('CNN0509' + str(name_index) + '.ckpt')
                    filename = os.path.join('/home/asdf/Documents/juyan/paper/paviau/dcpe/model/'

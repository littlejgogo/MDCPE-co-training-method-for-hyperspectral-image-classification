...
timesteps = 6
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/model/2_rnn/'
                                   'RNN05092.ckpt.meta')
batch_size = 5000
...
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/model/2_rnn/'
                                   'RNN05092.ckpt')
...
np.save("/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/test/all_rnnlogits.npy", rnnlogits)
...
# num_input = 17  # MNIST data input (img shape: 28*28)
# timesteps = 6
# saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/model/10_rnn/'
#                                    'RNN050910.ckpt.meta')
...
# rnnlogits = np.zeros((1, 9), dtype=np.float64)
# with tf.Session() as sess:
#     saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/model/10_rnn/'
#                                    'RNN050910.ckpt')
#     y = sess.graph.get_tensor_by_name('Softmax:0')
#     X = sess.graph.get_operation_by_name('X').outputs[0]
#     proba = sess.graph.get_tensor_by_name('add:0')
...
#
# rnnlogits = rnnlogits[1:]
# np.save("/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/model/10_rnn/logits.npy", rnnlogits)

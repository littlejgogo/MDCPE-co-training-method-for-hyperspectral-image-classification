...
mat_gt = sio.loadmat("/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/data/rnn/PaviaU_gt.mat")
GT = mat_gt['paviaU_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
data_mat = sio.loadmat('/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/data/rnn/pca_paviau.mat')
...
labeled_sets = np.load('/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/data/rnn/labeled_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/data/rnn/valid_index.npy')
unlabeled_sets = np.load('/home/asdf/Documents/juyan/paper/paviau/mdcpe/newmdcpe/data/rnn/unlabeled_index.npy')

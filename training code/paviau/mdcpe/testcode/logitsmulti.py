...
# import final_index
# import numpy as np
# saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviau/mdcpe/contrastive model/3/CNN/'
#                                    'CNN0509.ckpt.meta')
# batch_size = 2000
...
#     saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviau/mdcpe/contrastive model/3/CNN/'
#                                    'CNN0509.ckpt')
...
# rnnlogtis = np.load("/home/asdf/Documents/juyan/paper/paviau/mdcpe/contrastive model/3/RNN/logits.npy")
#
...
# np.savez('/home/asdf/Documents/juyan/paper/paviau/mdcpe/contrastive model/3/zhibiao0510.npz',
...
import final_index
import numpy as np
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviau/cnn/model/'
                                   'CNN0509.ckpt.meta')
...
cnnlogits = np.zeros((1, 9), dtype=np.float64)
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviau/cnn/model/'
                                   'CNN0509.ckpt')
    y = sess.graph.get_tensor_by_name('Softmax:0')
    X = sess.graph.get_operation_by_name('X').outputs[0]
    keep_prob = sess.graph.get_operation_by_name('keep_prob').outputs[0]
...
cnnlogits = cnnlogits[1:]
rnnlogtis = np.load("/home/asdf/Documents/juyan/paper/paviau/mdcpe/contrastive model/0/logits.npy")
...
every_class, confusion_mat = final_index.test_data_index(true_label, predict_label, 9)
np.savez('/home/asdf/Documents/juyan/paper/paviau/mdcpe/contrastive model/0/zhibiao0510.npz',
         every_class=every_class, confusion_mat=confusion_mat)
print("ok")

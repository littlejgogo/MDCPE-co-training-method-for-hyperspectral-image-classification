...
# np.savez('/home/asdf/Documents/juyan/paper/paviac/svm-linear/test/zhibiao0521.npz',
...
pre_label = pre_label[1:]
np.save("/home/asdf/Documents/juyan/paper/paviac/svm-linear/test/pre_alllabel.npy", pre_label)
print("ok")

...
mat_gt = sio.loadmat('/home/asdf/Documents/juyan/paper/paviac/rnn/data/Pavia_gt.mat')
GT = mat_gt['pavia_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
data_mat = sio.loadmat('/home/asdf/Documents/juyan/paper/paviac/rnn/data/Pavia.mat')
...
test_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/rnn/data/test_index.npy')
# valid_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/rnn/data/valid_index.npy')

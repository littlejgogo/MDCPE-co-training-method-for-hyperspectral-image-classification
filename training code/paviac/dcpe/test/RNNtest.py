...
timesteps = 6
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviac/dcpe/model/7_rnn/'
                                   'RNN05117.ckpt.meta')
batch_size = 5000
...
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviac/dcpe/model/7_rnn/'
                                    'RNN05117.ckpt')
...
np.save("/home/asdf/Documents/juyan/paper/paviac/dcpe/testresult/all_logits.npy", rnnlogits)
...
# # rnnlogits = np.zeros((1, 9), dtype=np.float64)
# with tf.Session() as sess:
#     saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviac/dcpe/model/10_rnn/'
#                                    'RNN051110.ckpt')
#     y = sess.graph.get_tensor_by_name('Softmax:0')
#     X = sess.graph.get_operation_by_name('X').outputs[0]
#     proba = sess.graph.get_tensor_by_name('add:0')
...
# np.save("/home/asdf/Documents/juyan/paper/paviac/dcpe/model/10_rnn/logits.npy", rnnlogits)
# # every_class, confusion_mat = final_index.test_data_index(true_label, predict_label, 16)
# # np.savez('/home/asdf/Documents/juyan/paper/data/salinas/0418_15each_class/zhibiao0421_rnn15.npz',
# #          every_class=every_class, confusion_mat=confusion_mat)
# # print("ok")

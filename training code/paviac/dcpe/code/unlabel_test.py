...
batch_x1 = batch_x1.transpose((0, 3, 1, 2))
...
def update_cnn():
    ...
    same_cnn_index = same_indexall_cnn[:64]
    dcpe_cnn_index = remove_same_cnn[:64]
    ...
    unlabeled_sets_cnn = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/unlabeled_index.npy')
    labeled_sets_cnn = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/labeled_index.npy')
    mat_gt_cnn = sio.loadmat('/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/data/cnn/Pavia_gt.mat')
    GT_cnn = mat_gt_cnn['pavia_gt']
    cnn_index_bigmap = (unlabeled_sets_cnn[:5000])[cnn_index_all]
    ...
    unlabeled_sets_cnn = unlabeled_sets_cnn[5000:]
    np.save('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/unlabeled_index.npy', unlabeled_sets_cnn)
    np.save('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/labeled_index.npy', update_labeled_sets_cnn)
    sio.savemat('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/Pavia_gt.mat', {'pavia_gt': real_gt_cnn})
    return ()
...
def update_rnn():
    ...
    same_rnn_index = same_indexall_rnn[:64]
    dcpe_rnn_index = remove_same_rnn[:64]
    ...
    unlabeled_sets_rnn = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/unlabeled_index.npy')
    labeled_sets_rnn = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/labeled_index.npy')
    mat_gt_rnn = sio.loadmat('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/Pavia_gt.mat')
    GT_rnn = mat_gt_rnn['pavia_gt']
    rnn_index_bigmap = (unlabeled_sets_rnn[:5000])[rnn_index_all]
    ...
    unlabeled_sets_rnn = unlabeled_sets_rnn[5000:]
    np.random.shuffle(update_labeled_sets_rnn)
    np.save('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/unlabeled_index.npy',unlabeled_sets_rnn)
    np.save('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/labeled_index.npy', update_labeled_sets_rnn)
    sio.savemat('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/Pavia_gt.mat', {'pavia_gt': real_gt_rnn})
    return ()

...
mat_gt = sio.loadmat("/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/Pavia_gt.mat")
GT = mat_gt['pavia_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
data_mat = sio.loadmat('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/Pavia.mat')
...
labeled_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/labeled_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/valid_index.npy')
unlabeled_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/rnn/unlabeled_index.npy')

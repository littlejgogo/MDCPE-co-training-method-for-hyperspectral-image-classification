...
pca_data = sio.loadmat("/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/pca3_pavia.mat")
...
mat_gt = sio.loadmat("/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/Pavia_gt.mat")
GT = mat_gt['pavia_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
labeled_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/labeled_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/valid_index.npy')
unlabeled_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/dcpe/data/cnn/unlabeled_index.npy')

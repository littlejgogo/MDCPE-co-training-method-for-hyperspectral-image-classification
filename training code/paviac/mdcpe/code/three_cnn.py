        ...
        for step in range(1, num_steps+1):
            ...
            if step % 1000 == 0:
                ...
                if val_acc > best:
                    ...
                    filename = os.path.join('/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/model/cnn',
                                            filename)
                    saver.save(sess, filename)
                    filename = ('CNN0511' + str(name_index) + '.ckpt')
                    filename = os.path.join('/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/model/'

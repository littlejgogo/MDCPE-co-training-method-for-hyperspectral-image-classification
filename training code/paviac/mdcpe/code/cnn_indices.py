...
pca_data = sio.loadmat("/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/data/cnn/pca3_pavia.mat")
...
mat_gt = sio.loadmat("/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/data/cnn/Pavia_gt.mat")
GT = mat_gt['pavia_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
labeled_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/data/cnn/labeled_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/data/cnn/valid_index.npy')
unlabeled_sets = np.load('/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/data/cnn/unlabeled_index.npy')
...
class DataSet(object):
  ...
  def next_batch_test(self, batch_size):
      ...
      hsi_batch_patch = np.zeros((end-start, batch, batch, INPUT_DIMENSION), dtype=np.float32)
      col = data_IN.shape[1]

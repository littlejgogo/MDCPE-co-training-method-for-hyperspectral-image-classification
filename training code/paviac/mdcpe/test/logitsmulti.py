...
import final_index
import numpy as np
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/model/2_cnn/'
                                   'CNN05112.ckpt.meta')
batch_size = 5000
...
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/model/2_cnn/'
                                   'CNN05112.ckpt')
...
rnnlogtis = np.load("/home/asdf/Documents/juyan/paper/paviac/mdcpe/testresult/all_logits.npy")
...
# print("ok")
np.save("/home/asdf/Documents/juyan/paper/paviac/mdcpe/testresult/pre_alllabel.npy", predict_label)
...
# import final_index
# import numpy as np
# saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/model/10_cnn/'
#                                    'CNN051110.ckpt.meta')
...
# # prediction = prediction[1:]
# cnnlogits = cnnlogits[1:]
# rnnlogtis = np.load("/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/model/9_rnn/logits.npy")
#
# norm_rnn = np.zeros((cnnlogits.shape[0], cnnlogits.shape[1]), dtype=np.float32)
# norm_cnn = np.zeros((cnnlogits.shape[0], cnnlogits.shape[1]), dtype=np.float32)
# max_cnn = np.amax(cnnlogits, axis=1)
...
#
# every_class, confusion_mat = final_index.test_data_index(true_label, predict_label, 9)
# np.savez('/home/asdf/Documents/juyan/paper/paviac/mdcpe/newmdcpe/model/9_rnn/zhibiao0515highest.npz',
#          every_class=every_class, confusion_mat=confusion_mat)
# print("ok")

...
# timesteps = 6
# saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviac/mdcpe/contrastive model/7/RNN/'
#                                    'RNN0511.ckpt.meta')
# batch_size = 2000
...
#     saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviac/mdcpe/contrastive model/7/RNN/'
#                                    'RNN0511.ckpt')
...
# np.save("/home/asdf/Documents/juyan/paper/paviac/mdcpe/contrastive model/7/RNN/logits.npy", rnnlogits)
...
num_input = 17  # MNIST data input (img shape: 28*28)
timesteps = 6
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/paviac/rnn/model/'
                                   'RNN0511.ckpt.meta')
...
rnnlogits = np.zeros((1, 9), dtype=np.float64)
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/paviac/rnn/model/'
                                   'RNN0511.ckpt')
    y = sess.graph.get_tensor_by_name('Softmax:0')
    X = sess.graph.get_operation_by_name('X').outputs[0]
    proba = sess.graph.get_tensor_by_name('add:0')
...
# true_label = np.argmax(true_label[1:], 1) + 1
rnnlogits = rnnlogits[1:]
np.save("/home/asdf/Documents/juyan/paper/paviac/mdcpe/contrastive model/0/logits.npy", rnnlogits)
# every_class, confusion_mat = final_index.test_data_index(true_label, predict_label, 16)
# np.savez('/home/asdf/Documents/juyan/paper/data/salinas/0418_15each_class/zhibiao0421_rnn15.npz',
#          every_class=every_class, confusion_mat=confusion_mat)
# print("ok")

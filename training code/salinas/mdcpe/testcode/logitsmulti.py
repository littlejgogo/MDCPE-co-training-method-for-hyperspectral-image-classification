...
import final_index
import numpy as np
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/model/2_cnn/'
                                   'CNN05072.ckpt.meta')
batch_size = 2000
# prediction = np.zeros((1, 16), dtype=np.int32)
# true_label = np.zeros((1, 16), dtype=np.int32)
cnnlogits = np.zeros((1, 16), dtype=np.float64)
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/model/2_cnn/'
                                   'CNN05072.ckpt')
...
rnnlogtis = np.load("/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/test/all2_rnnlogits.npy")
...
# np.savez('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/test/test10_zhibiao0522.npz',
#          every_class=every_class, confusion_mat=confusion_mat)
# print("ok")
np.save("/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/test/pre_alllabel.npy", predict_label)

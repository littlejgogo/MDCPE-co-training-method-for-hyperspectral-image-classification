...
timesteps = 12
logits_cnn = np.zeros((1, 16), dtype=np.float64)
prob_cnn = np.zeros((1, 16), dtype=np.float64)
logits_rnn = np.zeros((1, 16), dtype=np.float64)
prob_rnn = np.zeros((1, 16), dtype=np.float64)
...
batch_cnn_center = data_cnn.train.next_batch_test(305)
...
batch_rnn_center = data_rnn.train.next_batch_test(305)
batch_rnn_center = batch_rnn_center.reshape((305, timesteps, num_input))
...
cnn_center = norm_cnn[:16]
cnn_unlabeled = norm_cnn[16:]
rnn_center = norm_rnn[:16]
rnn_unlabeled = norm_rnn[16:]
...
def update_cnn():
    ...
    unlabeled_sets_cnn = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/cnn/unlabeled_index.npy')
    labeled_sets_cnn = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/cnn/labeled_index.npy')
    mat_gt_cnn = sio.loadmat('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/cnn/Salinas_gt.mat')
    ...
    np.save('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/cnn/unlabeled_index.npy', unlabeled_sets_cnn)
    np.save('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/cnn/labeled_index.npy', update_labeled_sets_cnn)
    sio.savemat('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/cnn/Salinas_gt.mat', {'salinas_gt': real_gt_cnn})
    return ()
...
def update_rnn():
    ...
    unlabeled_sets_rnn = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/unlabeled_index.npy')
    labeled_sets_rnn = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/labeled_index.npy')
    mat_gt_rnn = sio.loadmat('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/Salinas_gt.mat')
    ...
    np.save('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/unlabeled_index.npy', unlabeled_sets_rnn)
    np.save('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/labeled_index.npy', update_labeled_sets_rnn)
    sio.savemat('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/Salinas_gt.mat', {'salinas_gt': real_gt_rnn})
    return ()

        ...
        for step in range(1, training_steps+1):
            ...
            if step % 1000 == 0:
                ...
                if val_acc > best:
                    best = val_acc
                    print("Step " + str(step))
                    filename = ('RNN0507.ckpt')
                    filename = os.path.join('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/model/rnn',
                                            filename)
                    saver.save(sess, filename)
                    filename = ('RNN0507'+str(name_index)+'.ckpt')

...
mat_gt = sio.loadmat('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/Salinas_gt.mat')
GT = mat_gt['salinas_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
data_mat = sio.loadmat('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/Salinas_corrected.mat')
...
#
labeled_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/labeled_index.npy')
# # test_sets = np.load('/home/asdf/Documents/juyan/paper/data/salinas/rnn/test_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/valid_index.npy')
unlabeled_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/rnn/unlabeled_index.npy')

        ...
        for step in range(1, num_steps+1):
            ...
            if step % 500 == 0:
                ...
                if val_acc > best:
                    best = val_acc
                    print("Step " + str(step))
                    filename = ('CNN0507.ckpt')
                    filename = os.path.join('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/model/cnn',
                                            filename)
                    saver.save(sess, filename)
                    filename = ('CNN0507' + str(name_index) + '.ckpt')
                    filename = os.path.join('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/model/'

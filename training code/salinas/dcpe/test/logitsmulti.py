...
import final_index
import numpy as np
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/salinas/dcpe_result/model/3_cnn/'
                                   'CNN05073.ckpt.meta')
batch_size = 2000
...
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/salinas/dcpe_result/model/3_cnn/'
                                   'CNN05073.ckpt')
...
rnnlogtis = np.load("/home/asdf/Documents/juyan/paper/salinas/dcpe_result/test/all2_rnnlogits.npy")
...
# np.savez('/home/asdf/Documents/juyan/paper/salinas/dcpe_result/test/test6_zhibiao0522.npz',
#          every_class=every_class, confusion_mat=confusion_mat)
# print("ok")
np.save("/home/asdf/Documents/juyan/paper/salinas/dcpe_result/test/pre_alllabel.npy", predict_label)

...
timesteps = 12
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/salinas/dcpe_result/model/3_rnn/'
                                   'RNN05073.ckpt.meta')
batch_size = 2000
...
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/salinas/dcpe_result/model/3_rnn/'
                                   'RNN05073.ckpt')

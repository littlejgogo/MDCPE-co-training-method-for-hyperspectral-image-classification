...
pca_data = sio.loadmat("/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/original/pca3_salinas.mat")
...
mat_gt = sio.loadmat("/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/original/Salinas_gt.mat")
GT = mat_gt['salinas_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
# labeled_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/contractive model/CNN/DATA/labeled_index.npy')
test_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/original/test_index.npy')
# valid_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/newmdcpe/data/original/valid_index.npy')
# unlabeled_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/contractive model/CNN/DATA/unlabeled_index.npy')
all_sets = np.load("/home/asdf/Documents/juyan/paper/salinas/cnn/data/all_index.npy")
...
class DataSet(object):
  ...
  def next_batch(self, batch_size):
    ...
    hsi_batch_patch = hsi_batch_patch.transpose((0, 3, 1, 2))
  ...
  def next_batch_test(self, batch_size):
      ...
      hsi_batch_patch = np.zeros((end - start, 23, 23, INPUT_DIMENSION), dtype=np.float32)
      col = data_IN.shape[1]

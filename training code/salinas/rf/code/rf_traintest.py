...
rf = RandomForestClassifier(criterion="gini", max_features="sqrt",
                            n_estimators=200, min_samples_leaf=1, n_jobs=-1, oob_score=False)
...
# np.savez('/home/asdf/Documents/juyan/paper/salinas/rf/test/test_zhibiao0522.npz',
...
pre_label = pre_label[1:]
np.save("/home/asdf/Documents/juyan/paper/salinas/rf/test/pre_alllabel.npy", pre_label)
print("ok")
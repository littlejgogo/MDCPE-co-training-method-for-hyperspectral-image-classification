...
mat_gt = sio.loadmat('/home/asdf/Documents/juyan/paper/salinas/rnn/data/Salinas_gt.mat')
GT = mat_gt['salinas_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
data_mat = sio.loadmat('/home/asdf/Documents/juyan/paper/salinas/rnn/data/Salinas_corrected.mat')
...
test_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/rnn/data/test_index.npy')
# valid_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/rnn/data/valid_index.npy')

...
plt.plot(T_sa, power_sa, color='green', linestyle="-", label='SA data set')
plt.plot(T_sa, power_pu, 'rD')
plt.plot(T_sa, power_pu, color='red', linestyle="-", label='PU data set')
plt.plot(T_sa, power_pc, 'bs')
plt.plot(T_sa, power_pc, color='blue', linestyle="-", label='PC data set')
plt.legend(loc='best')
...
# plt.show()
plt.savefig("/home/asdf/Documents/juyan/paper/figure/upeachclass.jpg")

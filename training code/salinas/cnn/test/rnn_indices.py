...
mat_gt = sio.loadmat('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/contractive model/11/RNN/DATA/Salinas_gt.mat')
GT = mat_gt['salinas_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
data_mat = sio.loadmat('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/contractive model/11/RNN/DATA/Salinas_corrected.mat')
...
test_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/contractive model/11/RNN/DATA/test_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/salinas/mdcpe_result/contractive model/11/RNN/DATA/valid_index.npy')

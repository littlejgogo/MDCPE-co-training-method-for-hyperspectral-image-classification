...
test_indices = np.load("/home/asdf/Documents/juyan/paper/paviac/cnn/data/test_index.npy")
uPavia = sio.loadmat('/home/asdf/Documents/juyan/paper/paviac/cnn/data/Pavia.mat')
gt_uPavia = sio.loadmat('/home/asdf/Documents/juyan/paper/paviac/cnn/data/Pavia_gt.mat')
data_IN = uPavia['pavia']
gt_IN = gt_uPavia['pavia_gt']
...
model = load_model('/home/asdf/Documents/juyan/SSRN-master/juyan/model/PC_1.hdf5')
pre_test_pro = np.array([])
for index_iter in tqdm(range(whole_data.shape[0])):
    x_test = hsi_test_data(batch_size=715, patch_size=23, index_iter=index_iter)
...
np.save('/home/asdf/Documents/juyan/SSRN-master/juyan/result/pc_0712.npy', pre_test_pro)

...
def update_cnn():
    ...
    unlabeled_sets_cnn = np.load('/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/unlabeled_index.npy')
    labeled_sets_cnn = np.load('/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/labeled_index.npy')
    mat_gt_cnn = sio.loadmat('/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/Salinas_gt.mat')
    ...
    np.save('/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/unlabeled_index.npy', unlabeled_sets_cnn)
    np.save('/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/labeled_index.npy', update_labeled_sets_cnn)
    sio.savemat('/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/Salinas_gt.mat', {'salinas_gt': real_gt_cnn})
    return ()
...
def update_rnn():
    ...
    unlabeled_sets_rnn = np.load('/home/asdf/Documents/juyan/paper/no_kmeans/data/rnn/unlabeled_index.npy')
    labeled_sets_rnn = np.load('/home/asdf/Documents/juyan/paper/no_kmeans/data/rnn/labeled_index.npy')
    mat_gt_rnn = sio.loadmat('/home/asdf/Documents/juyan/paper/no_kmeans/data/rnn/Salinas_gt.mat')
    ...
    np.save('/home/asdf/Documents/juyan/paper/no_kmeans/data/rnn/unlabeled_index.npy', unlabeled_sets_rnn)
    np.save('/home/asdf/Documents/juyan/paper/no_kmeans/data/rnn/labeled_index.npy', update_labeled_sets_rnn)
    sio.savemat('/home/asdf/Documents/juyan/paper/no_kmeans/data/rnn/Salinas_gt.mat', {'salinas_gt': real_gt_rnn})
    return ()

...
with g_cnn.as_default():
    ...
    weights = {
        ...
        'wc1': tf.Variable(tf.random_normal([4, 4, 2, 1, 32])),
        # 5x5 conv, 32 inputs, 64 outputs
        'wc2': tf.Variable(tf.random_normal([4, 4, 2, 32, 64])),
        ...
        for step in range(1, num_steps+1):
            ...
            if step % 2000 == 0:
                ...
                if val_acc > best:
                    best = val_acc
                    print("Step " + str(step))
                    filename = ('pretrain_CNN0418.ckpt')
                    filename = os.path.join('/home/asdf/Documents/juyan/paper/no_kmeans/model/cnn',
                                            filename)

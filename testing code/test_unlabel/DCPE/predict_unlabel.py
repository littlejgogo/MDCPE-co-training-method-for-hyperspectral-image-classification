...
def predict_models():
    class DataSets(object):
        pass
    pre_label = DataSets()
    pre_label.cnn = Predict('/home/asdf/Documents/juyan/paper/no_kmeans/model/cnn/pretrain_CNN0418.ckpt.meta',
                            '/home/asdf/Documents/juyan/paper/no_kmeans/model/cnn/pretrain_CNN0418.ckpt')
    pre_label.rnn = Predict('/home/asdf/Documents/juyan/paper/no_kmeans/model/rnn/pretrain_RNN0418.ckpt.meta',
                            '/home/asdf/Documents/juyan/paper/no_kmeans/model/rnn/pretrain_RNN0418.ckpt')
    return pre_label
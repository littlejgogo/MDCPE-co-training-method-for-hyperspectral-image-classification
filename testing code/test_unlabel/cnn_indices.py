...
pca_data = sio.loadmat("/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/pca3_salinas.mat")
...
mat_gt = sio.loadmat("/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/Salinas_gt.mat")
GT = mat_gt['salinas_gt']
GT = GT.reshape(np.prod(GT.shape[:2]),)
labeled_sets = np.load('/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/labeled_index.npy')
# test_sets = np.load('/home/asdf/Documents/juyan/paper/data/salinas/cnn/test_index.npy')
valid_sets = np.load('/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/valid_index.npy')
unlabeled_sets = np.load('/home/asdf/Documents/juyan/paper/no_kmeans/data/cnn/unlabeled_index.npy')

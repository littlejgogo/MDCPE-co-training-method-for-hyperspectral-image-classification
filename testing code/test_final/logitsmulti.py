...
saver = tf.train.import_meta_graph('/home/asdf/Documents/juyan/paper/co_training_code/newcode/'
                                            '041815eachclass/model/0_cnn/pretrain_CNN0418.ckpt.meta')
batch_size = 2000
...
with tf.Session() as sess:
    saver.restore(sess, '/home/asdf/Documents/juyan/paper/co_training_code/newcode/'
                                            '041815eachclass/model/0_cnn/pretrain_CNN0418.ckpt')
...
rnnlogtis = np.load("/home/asdf/Documents/juyan/paper/co_training_code/newcode/test_final/result/0_rnnresult.npy")
...
np.savez('/home/asdf/Documents/juyan/paper/data/salinas/0418_15each_class/zhibiao0424_0_cnn+0_rnn.npz',
